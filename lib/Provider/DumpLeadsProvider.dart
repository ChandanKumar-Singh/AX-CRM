...
class DumpLeadsProvider with ChangeNotifier {
  late String token;
  late String role;

  String TAG = 'DumpLeadsProvider';
  ...
  Future<void> getDumpedLeads() async {
  ...
  Future<void> applyFilter(DumpLeadsProvider lp) async {
    var statusString = '';
    var sourcesString = '';
